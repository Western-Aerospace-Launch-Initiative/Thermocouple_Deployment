...
#include <PEP_GS_Main/Top/PEP_GS_MainTopology.hpp>
...
static void signalHandler(int signum) {
    PEP_GS_Main::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    PEP_GS_Main::TopologyState inputs;
    ...
    PEP_GS_Main::setupTopology(inputs);
    PEP_GS_Main::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    PEP_GS_Main::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
