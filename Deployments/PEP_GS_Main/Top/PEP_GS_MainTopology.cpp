// ======================================================================
// \title  PEP_GS_MainTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <PEP_GS_Main/Top/PEP_GS_MainTopologyAc.hpp>
#include <PEP_GS_Main/Top/PEP_GS_MainPacketsAc.hpp>
...
void configureTopology() {
    ...
    //tlmSend.setPacketList(PEP_GS_MainPacketsPkts, PEP_GS_MainPacketsIgnore, 1);
}

// Public functions for use in main program are namespaced with deployment name PEP_GS_Main
